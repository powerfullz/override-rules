...
const baseRules = [
    ...
    `AND,((RULE-SET,StaticResources),(GEOSITE,cn)),DIRECT`,
    `AND,((RULE-SET,StaticResources),(GEOIP,cn,no-resolve)),DIRECT`,
    `AND,((RULE-SET,CDNResources),(GEOSITE,cn)),DIRECT`,
    `AND,((RULE-SET,CDNResources),(GEOIP,cn,no-resolve)),DIRECT`,
    `AND,((RULE-SET,AdditionalCDNResources),(GEOSITE,cn)),DIRECT`,
    `AND,((RULE-SET,AdditionalCDNResources),(GEOIP,cn,no-resolve)),DIRECT`,
